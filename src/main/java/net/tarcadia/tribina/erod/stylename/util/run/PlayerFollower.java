...
public class PlayerFollower extends BukkitRunnable {
    ...
    public PlayerFollower(@NotNull Player player) {
        ...
        this.runTaskTimerAsynchronously(StyleName.plugin, 0, 4);
    }
    ...
    public void run() {
        ...
        if (this.lastGM.equals(GameMode.SPECTATOR) && !nowGM.equals(GameMode.SPECTATOR)) this.follower.canViewFollower(true);
        ...
        boolean ifMove = (this.lastLoc.getX() != nowLoc.getX() || this.lastLoc.getY() != nowLoc.getY() || this.lastLoc.getZ() != nowLoc.getZ());
